...
class MainContainer extends React.Component {
  ...
  changeTokenAPI = () => {
    let params = {
      token: this.props.phoneNumber === undefined ? "2059538278" : this.props.phoneNumber,
    ...
    return (
      ...
      >
        ...
        <View style={{ flex: 1 }}>
          ...
          <MainBottomMenu selectedIndex={0} onItemSelected={(index)=>this.onBottomMenuSelected(index)} style={styles.bottomMenu}/>
        </View>
      </MainBaseContainer>
    );
  }
